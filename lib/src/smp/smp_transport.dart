...
///
/// This is the seam that keeps everything above it transport-agnostic. Provide
/// your own implementation for BLE (e.g. on `universal_ble`), serial, or TCP;
/// the identical `SmpClient` and management-group facades work unchanged over
/// any of them. See the package README for a minimal transport skeleton.
///
